...
<div class="pageContent">
    <form method="post" action="${ctx}/recruit/worry/save" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this,dialogReloadNavTab)">
    	<input type="hidden" name="jobAttribute" value="1" />
        ...
        <div class="pageFormContent" layoutH="50">
           ...
           <div class="unit">
                <label>人数：</label>
				<input name="numberJob" class="validate[required,maxSize[32]] required" size="30" />
           </div>
           <div class="unit">
                <label>佣金：</label>
				<input name="commission" class="validate[required,maxSize[32]] required" size="30" />
           </div>
           <div class="unit">
                <label>到岗开始时间：</label>
				<input name="workArrivalStart" type="text" class="validate[required,custom[date],past[#regulartime]] text-input date required" size="30" readonly="readonly" minDate="{%y-100}-%M-%d" maxDate="{%y+100}-%M-{%d}" /><a class="inputDateButton" href="javascript:;">选择</a>
           </div>
           <div class="unit">
                <label>到岗结束时间：</label>
				<input name="workArrivalEnd" type="text" class="validate[required,custom[date],past[#regulartime]] text-input date required" size="30" readonly="readonly" minDate="{%y-100}-%M-%d" maxDate="{%y+100}-%M-{%d}" /><a class="inputDateButton" href="javascript:;">选择</a>
           </div>
           <div class="unit">
                <label>详细地址：</label>
