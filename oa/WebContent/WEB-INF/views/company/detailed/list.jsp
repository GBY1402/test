...
<form id="pagerForm" method="post" action="${ctx }/hrWalletDetail">
...
<form id="searchForm" method="post" action="${ctx}/hrWalletDetail" onsubmit="return navTabSearch(this)">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		<shiro:hasPermission name="HrWalletDetail:save">
			<li><a  width="600" height="300" rel="lookup2organization_add" class="add" href="${ctx}/hrWalletDetail/create" target="dialog" mask="true"><span>添加</span></a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="HrWalletDetail:edit">
			<li><a  width="600" height="300" rel="hrwalletdetail_edit" class="edit" href="${ctx}/hrWalletDetail/${emp.detailedId}/{sid_user}/update" target="dialog" mask="true"><span>修改</span></a></li>
		</shiro:hasPermission>
		<li class="line">line</li>
		<%-- <shiro:hasPermission name="HrWalletDetail:view">
		...
		<shiro:hasPermission name="HrWalletDetail:delete">
		<li><a class="delete" href="${ctx}/hrWalletDetail/${emp.detailedId}/{sid_user}/delete" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
		</shiro:hasPermission>
		<li class="line">line</li>
		<shiro:hasPermission name="Persondetailed:view">
			<li><a  width="850" height="450"  class="icon" href="${ctx}/hrWalletDetail/${emp.detailedId}/{sid_user}/payment" target="ajaxTodo" title="确定要结算吗?"><span>结算</span></a></li>
		</shiro:hasPermission>
		</ul>
	</div>
    ...
    <tbody>
        <c:forEach items="${page.content}" var="emp">
            <tr target="sid_user" rel="${emp.detailedId}">
            	<td>${emp.enterHRWalletInfo.enterPersonInfo.humanBasicInfo.humanName }</td>
                <td>
