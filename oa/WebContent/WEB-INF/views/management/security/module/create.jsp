...
<form id="permissionForm" method="post" action="${ctx }/management/security/module/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadRel2Org);">
