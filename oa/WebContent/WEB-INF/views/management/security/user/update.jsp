...
<form method="post" action="${ctx}/management/security/user/update" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
	...
	<div class="pageFormContent" layoutH="58">
		...
		<p>
			<label>所属员工：</label>	
			<input name="employee.pkid" type="hidden" value="${user.employee.pkid }"/>
			<input class="validate[required] required" name="employee.name" type="text" value="${user.employee.name }" readonly="readonly"/>
		</p>		
		<p>
			<label>电话：</label>
