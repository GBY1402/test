...
<div class="pageContent">
	<form method="post" action="${ctx }/persondetailed/create" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this,dialogReloadNavTab)">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
			<label>所属用户：</label>	
			<input name="walletInfo.walletId" value="${walletInfo.walletId}" type="hidden" />
			<input class="validate[required] required" name="walletInfo.updateUser" type="text" readonly="readonly" />
