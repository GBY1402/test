...
<div class="pageContent">
	<form method="post" action="${ctx }/bole/create" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this,dialogReloadNavTab)">
		<div class="pageFormContent" layoutH="56">
			<p>
				<label>伯乐昵称：</label>
				<input name="boleName" class="validate[required,maxSize[30]] required" type="text" size="30" value="${personBoleInfo.boleName }"/>
			</p>
			<div class="unit">
				<label>伯乐头像：</label>
			...
			<input class="validate[required] required" name="humanBasicInfo.humanName" type="text" readonly="readonly" value="${personBoleInfo.humanBasicInfo.humanName }"/>
