...
package com.lh.it.resource.utils.dwz;
...
public class AjaxObject {
	...
	public final static int STATUS_CODE_WARNING = 404;
	...
	public static AjaxObject newWarning(String message) {
		
		return new AjaxObject(STATUS_CODE_WARNING, message);
	}
