...
public class UntilOrder {
	...
	public UntilOrder(String uniteOrderid, String appid, String mch_id,
			String device_info, String nonce_str, String sign, String body,
			...
			String trade_type, String product_id, String openid,
			String updateDate) {
		super();
		this.uniteOrderid = uniteOrderid;
		this.appid = appid;
	...
	public String toString() {
		return "UntilOrder [uniteOrderid=" + uniteOrderid + ", appid=" + appid
