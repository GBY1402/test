...
<div class="pageContent">
    <form method="post" action="${ctx}/recruit/hunting/save" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this,dialogReloadNavTab)">
    	<input type="hidden" name="jobAttribute" value="2" />
