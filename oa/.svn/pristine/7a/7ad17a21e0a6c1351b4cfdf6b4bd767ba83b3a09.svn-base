...
<form id="permissionForm" method="post" action="${ctx }/management/security/module/update" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadRel2Org);">
	...
	<div id="permissionFormContent" class="pageFormContent" layoutH="58">
		...
		<p>
			...
			<a class="btnLook" href="${ctx}/management/security/module/lookupParent/${module.id}" lookupGroup="parent" mask="true" title="更改父模块" width="400">查找带回</a>			
		</p>
		</fieldset>
		<fieldset>
		<legend>自定义授权</legend>
		...
		<legend>动态新增</legend>
			<p>
				<label>名称：</label>
				<input type="text" name="_name" class="validate[maxSize[32]] " size="32" maxlength="32" alt="请输入名称"/>
			</p>
			<p>
				<label>短名：</label>
				<input type="text" name="_shortName" class="validate[maxSize[16]] " size="16" maxlength="16" alt="请输入短名"/>
