...
<div class="pageContent">
    <form method="post" action="${ctx}/recruit/hunting/update" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this,dialogReloadNavTab)">
