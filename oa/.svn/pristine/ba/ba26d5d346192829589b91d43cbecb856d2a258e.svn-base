...
<div class="pageContent">
	<form method="post" action="${ctx }/hrWalletDetail/update" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this,dialogReloadNavTab)">
		...
		<div class="pageFormContent" layoutH="56">
			...
			<p>
			<label>所属HR：</label>	
			<input name="enterHRWalletInfo.walletID" type="hidden" value="${walletInfo.enterHRWalletInfo.walletID }" />
			<input class="validate[required] required" name="enterHRWalletInfo.enterPersonInfo.humanBasicInfo.humanName" value="${walletInfo.enterHRWalletInfo.enterPersonInfo.humanBasicInfo.humanName }" type="text" readonly="readonly" />
