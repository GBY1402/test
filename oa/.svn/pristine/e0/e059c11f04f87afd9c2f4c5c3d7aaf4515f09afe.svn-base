<%@page import="com.lh.it.resource.security.entity.main.RolePermission"%>
<%@page import="com.lh.it.resource.security.entity.main.Permission"%>
<%@page import="com.lh.it.resource.security.entity.main.Module"%>
<%@page import="com.lh.it.resource.security.entity.main.Role"%>
...
<form method="post" action="${ctx }/management/security/role/update" class="required-validate pageForm" onsubmit="return validateCallback(this, navTabAjaxDone);">
