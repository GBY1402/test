...
public class UniteOrderResult implements Serializable{
	...
	public UniteOrderResult(String uniteOrderResultId, String return_code,
			String return_msg, String appid, String mch_id, String device_info,
			String nonce_str, String sign, String result_code, String err_code,
			String err_code_des, String trade_type, String prepay_id,
			String code_url, String uniteOrder_id, String updateDate) {
		super();
		this.uniteOrderResultId = uniteOrderResultId;
		this.return_code = return_code;
		this.return_msg = return_msg;
	...
	public UniteOrderResult() {
		super();
		// TODO Auto-generated constructor stub
	}
	@Override
	public String toString() {
		return "UniteOrderResult [uniteOrderResultId=" + uniteOrderResultId
				+ ", return_code=" + return_code + ", return_msg=" + return_msg
				+ ", appid=" + appid + ", mch_id=" + mch_id + ", device_info="
				+ device_info + ", nonce_str=" + nonce_str + ", sign=" + sign
				+ ", result_code=" + result_code + ", err_code=" + err_code
				+ ", err_code_des=" + err_code_des + ", trade_type="
				+ trade_type + ", prepay_id=" + prepay_id + ", code_url="
				+ code_url + ", uniteOrder_id=" + uniteOrder_id
